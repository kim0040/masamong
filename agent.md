...
| **RAWG 게임** | - **메타크리틱 점수(metacritic)**\<br\>- **평균 플레이 시간(playtime)**\<br\>- **장르 및 태그(genres, tags)**\<br\>- **판매처(stores)** | "이 게임은 비평가들에게 88점을 받은 오픈월드 RPG로, 약 45시간의 플레이 타임을 가지며 Steam에서 구매 가능해요." 와 같이 게임 구매를 고려하는 사용자에게 **결정에 필요한 모든 정보**를 한 번에 제공합니다. |

...
_POLICIES = {
    ...
    SCHOOL_NOTICE_SCOPE: ConsentPolicy(
        ...
        notice=(
            ...
            "- 선택 수집: 사용자가 직접 제공한 캠퍼스·학과·입학 유형·현재 학적·"
            "관심 분야·알림 시각과 공지 피드백. 제공하지 않은 선택 정보는 추측하거나 "
            "요구하지 않음\n"
            "- 이용 목적: 사용자 조건에 맞는 학교 공지 선별, 우선순위 계산, digest 생성·DM 발송\n"
            "- 학교 사이트 전송 금지: 공개 공지 수집 요청에는 Discord ID, 사용자 입력, "
            "학과·학년·관심사 등 개인 프로필을 넣지 않음. 학교에는 고정된 공개 게시판 URL과 "
